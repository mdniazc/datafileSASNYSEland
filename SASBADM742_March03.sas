...
/*Show How to conduct all tests of CFA Quantitative Investment Analysis Book in SAS using Chapter 8 example. */

/*Proc corr on Chp8 data*/

/*copy data into an .cvs file and then use import function to read the data in SAS*/

proc means data = chp8;
var x y;
run;
